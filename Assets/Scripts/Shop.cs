...
public class Shop : MonoBehaviour
{
    ...
    public void SellHarvest(CollectedHarvest harvestToSell)
    {
        _coins += harvestToSell._amount * Planter._instance.GetPlantResourseByName(harvestToSell._name)._pricePerHarvest;
        OnCoinsChanged(_coins);
        Harvester._instance.RemoveHarvest(harvestToSell);
